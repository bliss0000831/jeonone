...
const boardsRow1 = [
  { id: "free", label: "마을 사랑방", icon: MessageSquare, href: "/board/c/free" },
  { id: "daily", label: "농업 일기", icon: Camera, href: "/board/c/daily" },
  { id: "share", label: "무료 나눔", icon: Gift, href: "/board/c/share" },
]
const boardsRow2 = [
  { id: "life", label: "살림 정보", icon: Lightbulb, href: "/board/c/life" },
  { id: "subsidy", label: "정부 지원금", icon: Coins, href: "/board/c/subsidy" },
  { id: "qna", label: "궁금해요", icon: HelpCircle, href: "/board/c/qna" },
]
