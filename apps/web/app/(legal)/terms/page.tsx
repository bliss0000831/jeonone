      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-6 text-sm text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc list-outside ml-5 space-y-1.5">
            <li><strong>서비스</strong>: 회사가 제공하는 부동산 정보, 중고거래, 나눔, 공동구매, 로컬푸드, 모임, 게시판, 채팅, 신장개업, 인테리어·이사·청소·수리 등 지역 기반 커뮤니티 및 정보 제공 서비스 일체.</li>
            <li><strong>이용자(회원)</strong>: 본 약관에 동의하고 서비스를 이용하는 자.</li>
            <li><strong>계정</strong>: 회원이 서비스를 이용하기 위해 생성·사용하는 식별자(이메일·소셜 로그인 ID).</li>
            <li><strong>게시물</strong>: 회원이 서비스에 게시·등록한 글, 이미지, 영상, 매물 정보, 댓글, 메시지 등 모든 형태의 정보.</li>
            <li><strong>포인트</strong>: 회사가 서비스 활동 보상 또는 결제 수단으로 부여·판매하는 가상의 적립금. 현금으로 환불되지 않으며 본 약관 및 별도 운영정책을 따릅니다.</li>
            <li><strong>전문가 회원</strong>: 공인중개사·인테리어·이사·청소·수리·로컬푸드 생산자 등 회사의 별도 인증 절차를 거쳐 사업자로 활동하는 회원.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ol className="list-decimal list-outside ml-5 space-y-1.5">
            <li>회사는 다음과 같은 서비스를 제공합니다.
              <ul className="list-disc list-outside ml-5 mt-1.5 space-y-1">
                <li>지역 부동산 매물 정보 게재 및 검색</li>
                <li>회원 간 중고거래·나눔·공동구매·로컬푸드 등 직거래 정보 게재</li>
                <li>지역 모임·신장개업·홈케어(인테리어·이사·청소·수리) 정보</li>
                <li>회원 간 채팅 및 메시지</li>
                <li>지역 게시판 및 댓글</li>
                <li>포인트 적립·결제·교환</li>
        ...
        <section>
          ...
          <ol className="list-decimal list-outside ml-5 space-y-1.5">
            <li>회원이 게시한 매물·중고거래·공동구매·로컬푸드 등의 정보, 가격, 품질, 거래 조건, 계약 이행 책임은 전적으로 해당 게시자(판매자/임대인 등)에게 있습니다.</li>
            ...
            <li>전문가 회원(공인중개사·인테리어·이사·청소·수리 등)이 제공하는 용역의 품질·자격·면허 보유 여부는 해당 회원이 직접 책임지며, 회사는 이를 보증하지 않습니다. 회사는 전문가 회원에 대한 기본 신원 확인을 수행하나, 실제 서비스 품질을 보증하는 것은 아닙니다.</li>
          </ol>
        </section>
        ...
        <section>
          ...
          <ol className="list-decimal list-outside ml-5 space-y-1.5">
            ...
            <li>포인트는 마지막 적립·사용일로부터 5년간 사용 내역이 없을 경우 자동 소멸합니다.</li>
        ...
        <section>
          ...
          <ul className="list-disc list-outside ml-5 space-y-1">
            ...
            <li>허위 매물·허위 정보·사기성 거래의 게시 또는 권유</li>
